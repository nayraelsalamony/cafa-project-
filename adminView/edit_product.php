...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE product SET name = '$name', price = '$price', pic = '$filename', category_id = $category WHERE product_id=$id";
                    ...
                    <div class="card card-body">
                        <form action="edit_product.php?id=<?php echo $_GET['id']; ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="name" name="name" class="form-control" value="<?php echo $row['name']; ?>" placeholder="Product Name" autofocus>
                            </div>
